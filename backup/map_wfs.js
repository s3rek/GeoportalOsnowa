...
var styleCmDefault = function(feature, resolution) {
	...
	else	
	{
		...
		if (feature.values_.features[0].values_.typ == 'PG')
		{
			typ = 'osnowa_poz';
			skala = 1;
		}
		else 		if (feature.values_.features[0].values_.typ == 'PP')
		{
			typ = 'osnowa_poz';
			skala = 0.6;
		}
		else if (feature.values_.features[0].values_.typ == 'WG')
		{
			typ = 'osnowa_wys';
			skala = 1.0;
		}
		...
		else if (feature.values_.features[0].values_.stan == 'dobry')
		{
			stan = '_dobry';
		}
		else if (feature.values_.features[0].values_.stan == 'nieodnaleziony')
		{
			stan = '_nieodnaleziony';
		}
